...
- 若**业务项目**中有 `state.yaml` 且包含 `current_phase`，可优先查看当前阶段对应的索引区块，再按需查看其他阶段。
...
- 索引文件可从本规范仓库的 `.cyber_team/process/project-docs/project-docs-index.yaml` 复制到业务项目 **docs 目录**后，按实际产出填写或新增路径。

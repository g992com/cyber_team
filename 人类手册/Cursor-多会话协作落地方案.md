...
0. **遵守业务项目规则**：遵守业务项目 `.cursor/rules/` 下已配置的规则（如文档发现、工作执行标准、角色边界与意图确认等）；执行前或遇角色边界、意图确认等歧义时，应先查阅该目录下的规则文件并严格遵守。
...
1. **遵守业务项目规则**：遵守业务项目 `.cursor/rules/` 下已配置的规则；你不得代做其他角色产出，流程与角色归属以规范库 mapping 及业务项目 `.cursor/rules/` 中的规则为准。
...
1. **遵守业务项目规则**：遵守业务项目 `.cursor/rules/` 下已配置的规则（如文档发现、工作执行标准、角色边界与意图确认等）；执行前或遇角色边界、意图确认等歧义时，应先查阅该目录下的规则文件并严格遵守。
